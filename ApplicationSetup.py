...
motor1Label = ttk.Label(DataContainer, text="20 A", font=("Arial", 12), foreground="white", background="black")
motor1Label.grid(row=1, column=1, padx=5)
motor2Label = ttk.Label(DataContainer, text="20 A", font=("Arial", 12), foreground="white", background="black")
motor2Label.grid(row=1, column=2, padx=5)
motor3Label = ttk.Label(DataContainer, text="20 A", font=("Arial", 12), foreground="white", background="black")
motor3Label.grid(row=1, column=3, padx=5)
motor4Label = ttk.Label(DataContainer, text="20 A", font=("Arial", 12), foreground="white", background="black")
motor4Label.grid(row=1, column=4, padx=5)
...
motor1Label = ttk.Label(DataContainer, text="???", font=("Arial", 12), foreground="white", background="black")
motor1Label.grid(row=2, column=1, padx=5)
motor2Label = ttk.Label(DataContainer, text="???", font=("Arial", 12), foreground="white", background="black")
motor2Label.grid(row=2, column=2, padx=5)
motor3Label = ttk.Label(DataContainer, text="???", font=("Arial", 12), foreground="white", background="black")
motor3Label.grid(row=2, column=3, padx=5)
motor4Label = ttk.Label(DataContainer, text="???", font=("Arial", 12), foreground="white", background="black")
motor4Label.grid(row=2, column=4, padx=5)
...
motor1Label = ttk.Label(DataContainer, text="2 m/s", font=("Arial", 12), foreground="white", background="black")
motor1Label.grid(row=3, column=1, padx=5)
motor2Label = ttk.Label(DataContainer, text="2 m/s", font=("Arial", 12), foreground="white", background="black")
motor2Label.grid(row=3, column=2, padx=5)
motor3Label = ttk.Label(DataContainer, text="2 m/s", font=("Arial", 12), foreground="white", background="black")
motor3Label.grid(row=3, column=3, padx=5)
motor4Label = ttk.Label(DataContainer, text="2 m/s", font=("Arial", 12), foreground="white", background="black")
motor4Label.grid(row=3, column=4, padx=5)
...
motor1Label = ttk.Label(DataContainer, text="50 deg", font=("Arial", 12), foreground="white", background="black")
motor1Label.grid(row=4, column=1, padx=5)
motor2Label = ttk.Label(DataContainer, text="50 deg", font=("Arial", 12), foreground="white", background="black")
motor2Label.grid(row=4, column=2, padx=5)
motor3Label = ttk.Label(DataContainer, text="50 deg", font=("Arial", 12), foreground="white", background="black")
motor3Label.grid(row=4, column=3, padx=5)
motor4Label = ttk.Label(DataContainer, text="50 deg", font=("Arial", 12), foreground="white", background="black")
motor4Label.grid(row=4, column=4, padx=5)
